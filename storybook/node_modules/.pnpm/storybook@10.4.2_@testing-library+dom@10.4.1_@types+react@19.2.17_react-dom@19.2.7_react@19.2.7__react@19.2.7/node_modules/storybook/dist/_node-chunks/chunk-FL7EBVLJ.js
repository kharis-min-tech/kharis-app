...
import {
  ...
  toPath,
  traversePathUp
} from "./chunk-FODLNFCP.js";
import {
  versions_default
} from "./chunk-BOVST5A6.js";
import {
  logger
} from "./chunk-L36PKDQP.js";
import {
  BUN_LOCKFILE,
  BUN_LOCKFILE_BINARY,
  NPM_LOCKFILE,
...
import {
  ...
  up,
  up2
} from "./chunk-O7TSSZXM.js";
import {
  importModule,
  resolveModulePath,
  resolvePackageDir,
  safeResolveModule
} from "./chunk-3MJQGFKY.js";
import {
  join,
  parse,
  resolve
} from "./chunk-HKR2K7HF.js";
import {
  require_dist
} from "./chunk-IDGTLYPU.js";
import {
  require_picocolors
} from "./chunk-AFCIL7SS.js";
import {
  slash
} from "./chunk-JJ2VMJ7Z.js";
import {
  glob,
  globSync
} from "./chunk-7VTLE5YX.js";
import {
  __commonJS,
  __esm,
  __export,
...
async function scanAndTransformFiles({
  ...
  let globby = (await import("./globby-A5OBERQV.js")).globby, sourceFiles = await globby([glob2], {
    ...commonGlobOptions(""),
    ignore: ["**/node_modules/**"],
    dot: !0,
    cwd: getProjectRoot(),
...
var transformImportFiles = async (files, renamedImports, dryRun) => {
  let errors = [], { default: pLimit } = await import("./p-limit-WM2X6HTW.js"), limit = pLimit(10);
  return await Promise.all(
    files.map(
      (file) => limit(async () => {
        try {
