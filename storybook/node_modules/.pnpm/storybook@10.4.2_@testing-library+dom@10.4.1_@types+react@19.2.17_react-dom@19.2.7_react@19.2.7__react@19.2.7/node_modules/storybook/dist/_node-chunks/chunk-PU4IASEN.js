...
import {
  require_build
} from "./chunk-V4WSMXU3.js";
import {
  STORYBOOK_FN_PLACEHOLDER,
  generateDummyArgsFromArgTypes,
  loadConfig,
  printConfig
} from "./chunk-GD4AVVJ6.js";
import {
  StorybookError
} from "./chunk-7WEMCKHC.js";
import {
  isI18nPackage,
  isRouterPackage,
  isStateManagementPackage,
  isStylingPackage
} from "./chunk-QGWCIQDL.js";
import {
...
var getComponentVariableName = async (name) => (await import("./camelcase-45NXQBQZ.js")).default(name.replace(/^[^a-zA-Z_$]*/, ""), { pascalCase: !0 }).replace(/[^a-zA-Z_$]+/, "");
